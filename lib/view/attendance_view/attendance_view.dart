...
class _AttendanceViewState extends State<AttendanceView>  with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: auth.userRole=="Staff"?Padding(
                  ...
                  SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        attendanceUserCard("Maggie Franklin", "Senior Class"),
                        attendanceUserCard("Desa Calic", "Junior Class"),
                        attendanceUserCard("Ashliegh Khalid", "All Classes"),
                        verticalSpacer(20),
                      ],
                    ),
                  ),
