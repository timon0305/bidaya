...
class _NotificationViewState extends State<NotificationView> {
  final List<Map<String, dynamic>> notifications = [
    ...
    },
    {
      ...
      "body":
          "Last chance to add a little extra to your Tuesday delivery. Lorem Impsum, Siant, Madelno Batngana Fotana",
      "isRead": true,
    ...
    },
    {
      "title": "Payment Due",
      "body":
          "Please May the required amount for Ellie. 590EGP Before due date.",
      "isRead": false,
          ...
          itemBuilder: (context, index) {
            ...
            final bgColor =
                item["isRead"]
                    ...
                    : AppColors.forestGrey.withValues(alpha: 0.2);
