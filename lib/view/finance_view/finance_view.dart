...
import 'package:quizzo/view/finance_view/widgets/staff_salary_details_pop_up.dart';
import 'package:quizzo/view/inventory_view/widgets/custom_invoice_shape.dart';
import 'package:quizzo/view/setting_view/setting_payment_view.dart';
...
class _FinanceSlipViewState extends State<FinanceSlipView> with SingleTickerProviderStateMixin {
      ...
      appBar: AppBar(
        ...
        leading: Row(
          children: [
            ...
            horizontalSpacer(10),
            customText(text: "Finance", fontWeight: FontWeight.w700, fontSize: 24, color: AppColors.blackShade),
            Spacer(),
                          ...
                          CustomPaint(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                  ...
                                  children: [
                                    horizontalSpacer(50),
                                    customText(text: "Add Parent Invoice", fontWeight: FontWeight.w700, fontSize: 16, color: AppColors.purple,),
                                    Spacer(),
                                    Container(
                                      height: 32.h,width: 32.w,
                                      decoration: BoxDecoration(
                                        borderRadius: BorderRadius.circular(8.r),
                                        border: Border.all(color: AppColors.purple,width: 1.w),
                                      ),
                                      child: Center(child: Icon(Icons.add,size: 18,color: AppColors.purple,)),
                                    ),
                                    horizontalSpacer(20),
                                  ]
                              ),
                          ...
                          CustomPaint(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                  ...
                                  children: [
                                    horizontalSpacer(50),
                                    customText(text: "Add Staff Invoice", fontWeight: FontWeight.w700, fontSize: 16, color: AppColors.purple,),
                                    Spacer(),
                                    Container(
                                      height: 32.h,width: 32.w,
                                      decoration: BoxDecoration(
                          ...
                          CustomPaint(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                  ...
                                  children: [
                                    horizontalSpacer(50),
                                    customText(text: "Add Expense Invoice", fontWeight: FontWeight.w700, fontSize: 16, color: AppColors.purple,),
                                    Spacer(),
                              Container(
                                height: 32.h,width: 32.w,
                                decoration: BoxDecoration(
