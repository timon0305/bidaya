              ...
              content: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    verticalSpacer(12),
                    customText(
                        text: "Are you sure you want to remove [STUDENT NAME] from the nursery? This action will permanently delete their record and cannot be undone.",
