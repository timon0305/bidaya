    ...
    return Scaffold(
              ...
              builder: (context, auth, child) {
                return Column(
                  children: [
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: LinearProgressIndicator(
                                value: auth.accountType == "Nursery Owner"
                    ...
                    Expanded(
                      child: (auth.accountType == "Nursery Owner")?PageView(
                        ...
                        children: [
                          ...
                          setPassword(context: context,
                              showPassword: auth.showPassword,
                              showConfirmPassword: auth.showConfirmPassword,
                              confirmPasswordTextController: auth
                            ...
                            aboutNursery(
                                ...
                                addressController: auth
                                    .nurseryAddressController,
                                selectedCity: auth.selectedCity ?? "",
                                selectedCountry: auth.selectedCountry ?? ""
                            ),
                          otpView(context,otpControllers: auth.otpControllers),
                        ],
                      ):PageView(
                        controller: auth.controller,
        ...
        bottomNavigationBar: Consumer<SignupViewModel>(
            builder: (context, vm, child) {
              return vm.currentStep >= 1 ? Padding(
                padding: EdgeInsets.only(left: 18.w, bottom: 30.h, top: 10.h, right: 18.w),
                child: customButton(
                  context: context,
                  text: "Continue",
                  fontSize: 16,
                  ...
                  fontWeight: FontWeight.w600,
                    onPressed: () {
                      print("Current Step: ${vm.currentStep}, AccountType: ${vm.accountType}");

                      // dynamic last index
                      final lastStepIndex = vm.accountType == "Nursery Owner" ? 4 : 3;
                      ...
                      if (vm.currentStep == 1) {
                        ...
                        if (AppConstant.otp == vm.otpControllers) {
                          ...
                          snackBar(title: "Error", subTitle: "Invalid OTP", bgColor: AppColors.redShade);
                        }
                      }
