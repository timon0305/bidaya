...
Widget selectAccountCard() {
  return Consumer<SignupViewModel>(
      ...
      return Column(
        ...
        children: [
          verticalSpacer(60),
          customText(text: "What type of account do you like to create? 👦",
              textAlign: TextAlign.center,
              fontWeight: FontWeight.w700, fontSize: 32, color:AppColors.blackShade),
          verticalSpacer(40),
          accountCard("Nursery Owner", AppColors.blueShade,AppImages.user,nextStep: () {
            auth.updateAccountType("Nursery Owner");

          },),
          accountCard("Teacher", AppColors.amber,AppImages.teacher,nextStep: () {
            auth.updateAccountType("Teacher");

          },),
          accountCard("Parent",AppColors.teal,AppImages.parent,nextStep: () {
...
Widget infoCard(
  ...
  return Padding(
    ...
    child: Column(
      ...
      children: [
        verticalSpacer(20),
        customText(text: "Tell Us About Yourself ✨",
            textAlign: TextAlign.center,
            fontWeight: FontWeight.w700, fontSize: 32, color:AppColors.blackShade),
        verticalSpacer(40),
        Column(
          ...
          children: [
            ...
            customDropdownField(
              ...
              value: (selectedGender.isEmpty || selectedGender == "Select")
                  ? "Select"
                  : selectedGender,
              onChanged: (val) {
                if (val != null) {
...
Widget setPassword( {required BuildContext context,
  ...
  return  Padding(
    ...
    child: Column(
        ...
        children: [
          verticalSpacer(40),
          customText(text: "Set Your Password ✨ 🔐", fontWeight: FontWeight.w700, fontSize: 32, color: AppColors.blackShade),
          verticalSpacer(20),
          customText(text: "Create a new password", fontWeight: FontWeight.w700, fontSize: 16, color: Colors.black),
          verticalSpacer(4),
          ...
          verticalSpacer(20),
          customText(text: "Confirm a new password", fontWeight: FontWeight.w700, fontSize: 16, color: Colors.black),
          verticalSpacer(4),
          customTextFieldNoMultiLine(
...
Widget aboutNursery( {required BuildContext context,
  ...
  return  Padding(
    ...
    child: SingleChildScrollView(
      child: Column(
          ...
          children: [
            verticalSpacer(40),
            customText(text: "About Your Nursery 🏫", fontWeight: FontWeight.w700, fontSize: 32, color: AppColors.blackShade),
            verticalSpacer(20),
          ...
          return GestureDetector(
            ...
            verticalSpacer(20),
            customText(text: "City *", fontWeight: FontWeight.w700, fontSize: 16, color: Colors.black),
            verticalSpacer(4),
            customDropdownField(
              context: context,
              hintText: "",
            ...
            verticalSpacer(20),
            customText(text: "Country *", fontWeight: FontWeight.w700, fontSize: 16, color: Colors.black),
            verticalSpacer(4),
            customDropdownField(
              context: context,
              hintText: "",
            ...
            verticalSpacer(20),
            customText(text: "Nursery Phone Number (optional)", fontWeight: FontWeight.w700, fontSize: 16, color: Colors.black),
            verticalSpacer(4),
            customTextField(
              controller: addressController,
              height: 48,
            ...
            verticalSpacer(20),
            customText(text: "Nursery Email (optional)", fontWeight: FontWeight.w700, fontSize: 16, color: Colors.black),
            verticalSpacer(4),
            customTextField(
...
List<Widget> addChoiceChips(BuildContext context, List<String> list) {
  ...
  return list.map((category) {
    ...
    return ChoiceChip(
      ...
      showCheckmark: false,
      onSelected: (selected) =>
          provider.onToggleChip(category, selected),
    ...
    child: SingleChildScrollView(
      child: Column(
          ...
          children: [
            ...
            verticalSpacer(20),
            Center(child: customText(text: "You’ve got a text! 📲", fontWeight: FontWeight.w700, fontSize: 32, color: AppColors.blackShade)),
            verticalSpacer(20),
...
Widget accountCard(String title, Color color,String icon,{required VoidCallback nextStep}) {
  return GestureDetector(
    onTap: nextStep,
    child: Container(
      height: 92.h,
        ...
        children: [
          Container(
              ...
              child: Center(child: CircleAvatar(
                backgroundColor: AppColors.blackShade.withValues(alpha:0.1), radius: 30.r,
                child: SvgPicture.asset(icon),),
              ),
          ),
          horizontalSpacer(12),
          customText(text: title, fontWeight: FontWeight.w700, fontSize: 24, color: Colors.black),
