              ...
              content: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    verticalSpacer(12),
                    customText(
                        text: "Enter the phone number of the staff member you want to add to your nursery.", fontWeight: FontWeight.w400,
                        fontSize: 14,
                        color: AppColors.blackShade),
                    verticalSpacer(8),
                    customText(
                    ...
                    onPressed: (){
                      Get.to(()=>AddStaffView(phone: newController.text,isEdit: false,));
                    }
                    )
                  ],
                ),
