...
Future<String?> removeStaffPopup(
              ...
              content: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    verticalSpacer(12),
                    customText(
                        text: "Are you sure you want to remove [STAFF NAME] from the nursery? This action cannot be undone.", fontWeight: FontWeight.w400,
                        fontSize: 14,
                        color: AppColors.blackShade),
                    verticalSpacer(20),
                    Row(
