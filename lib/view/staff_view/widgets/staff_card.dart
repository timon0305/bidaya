   ...
   Get.to(()=>StaffViewDetail());
    ...
    Get.to(()=>AddStaffView(phone: "+1 305-555-0199",isEdit: true,));
        ...
        itemBuilder: (context) => [
          ...
          popupItem0(3, "Assign to class",icon: Icons.arrow_forward,isDivider: true,isIcon: true),
          popupItem0(3, "Set as admin",popupIcon: AppImages.profile,isDivider: true,isIcon: false),
