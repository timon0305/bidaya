...
Future<String?> addFoodReportPopup(
      ...
      return Stack(
        children: [
          ...
          AlertDialog(
            ...
            contentPadding: EdgeInsets.symmetric(horizontal: 0.w, vertical: 24.h),
            title:  customText(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: [
                              imageWithText(title: "Breakfast",image: AppImages.breakFast,context: context),
                              imageWithText(title: "Snack",image: AppImages.snack,context: context),
                              imageWithText(title: "Lunch",image: AppImages.reportLunchMeal,context: context),
                            ],
                          ),
                        ),
                        verticalSpacer(12),
                        ...
                        Padding(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: [
                              imageWithText2(title: "All",image: AppImages.allFood,context: context),
                              imageWithText2(title: "Some",image: AppImages.someFood,context: context),
                              imageWithText2(title: "None",image: AppImages.noFood,context: context),
                            ],
                          ),
                        ),
                        verticalSpacer(12),
