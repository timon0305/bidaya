...
class SettingManageSubscription extends StatefulWidget {
  ...
  @override
  State<SettingManageSubscription> createState() => _SettingManageSubscriptionState();
}
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ClipRRect(
                ...
                child: Image.asset(AppImages.subPlaceholder, height: 100.h,width: 390.w, fit: BoxFit.cover,),
              ),
              verticalSpacer(12),
              Align(
                  alignment: Alignment.topLeft,
                  child: customText(text: "Current Plan:", fontWeight: FontWeight.w700, fontSize: 16, color: Colors.black)),
              verticalSpacer(12),
          Container(
            width: 334.w,
          ...
          verticalSpacer(12),
              Align(
                  alignment: Alignment.topLeft,
                  child: customText(text: "Plans:", fontWeight: FontWeight.w700, fontSize: 16, color: Colors.black)),
              verticalSpacer(12),
          Container(
            width: 334.w,
            padding:  EdgeInsets.symmetric(horizontal: 12.w,vertical: 12.h),
            ...
            child: Column(
              ...
              children: [
                ...
                verticalSpacer(10),
                customText(
                    text: "Try Bidaya completely free for 14 days! Explore all the core features with no credit card required. Perfect for testing how Bidaya system can simplify managing your nursery.",
              ...
              verticalSpacer(12),verticalSpacer(12),
          Container(
            width: 334.w,
            padding:  EdgeInsets.symmetric(horizontal: 12.w,vertical: 12.h),
            decoration: BoxDecoration(
            ...
            child: Column(
              ...
              children: [
                ...
                verticalSpacer(10),
                customText(
                    text: "Flexible and affordable. Ideal for nurseries that want to grow month-by-month with full access to Bidaya's",
                    fontWeight: FontWeight.w500,
                    fontSize: 14,
                    color: AppColors.sand),
                verticalSpacer(12),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                verticalSpacer(10),
                customText(
                    text: "Save 20% with our most popular plan! Designed for nurseries looking for long-term growth and stability. Includes everything in the Monthly Plan plus 2 months free (you save EGP 2,160!)",
                    fontWeight: FontWeight.w500,
                    fontSize: 14,
                    color: AppColors.sand),
                verticalSpacer(12),
