          ...
          child: Column(
            ...
            children: [
              ...
              customListTile(context,
                  title: "Personal Info",
                  image: AppImages.userSetting, onPressed: () {
             ...
             if(auth.userRole!="Parent") ...[
                customListTile(context,
                    title: "Nursery Info",
                    image: AppImages.homeSetting,onPressed: () {
                      Get.toNamed(AppRoutes.settingNursery);
                    }),
                customListTile(context,
                    title: "Send Notification",
                    image: AppImages.notificationSetting, onPressed: () {
                      Get.toNamed(AppRoutes.sendNotification);

                    }),
                customListTile(context,
                    title: "Teacher Permission",
                    image: AppImages.permissionSetting, onPressed: () {
                ...
                customListTile(context,
                    title: "Subscription",
                    image: AppImages.subSetting, onPressed: () {
              ...
              customListTile(context,
                  ...
                  image: AppImages.passwordSetting, onPressed: () {
                    setPasswordPopUp(context);

                  }),
              customListTile(context,
                  title: "App Settings",
                  image: AppImages.appSetting, onPressed: () {

                  Get.toNamed(AppRoutes.appSetting);
                  },),
              customListTile(context,
                  title: "Contact Us",
                  image: AppImages.contactSetting, onPressed: () {
    ...
    child: GestureDetector(
      ...
      child: Row(
        children: [
          ...
          image==AppImages.logoutSetting?SizedBox.shrink():Icon(
