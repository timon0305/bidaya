...
class _SelectPaymentViewState extends State<SelectPaymentView> {
  ...
  final options = <PaymentOption>[
    PaymentOption(id: 'whatsapp', title: 'WhatsApp', icon: AppImages.whatsapp),
    PaymentOption(id: 'card', title: 'Pay With Card', icon: AppImages.pay),
    PaymentOption(id: 'gplay', title: 'Google Play', icon: AppImages.playStore),
    PaymentOption(id: 'apple', title: 'Apple Store', icon: AppImages.appStore),
    PaymentOption(id: 'huawei', title: 'Huawei Store', icon: AppImages.huawei),
  ];
  @override
...
Widget paymentTile({
  ...
  return GestureDetector(
    ...
    child: AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color:
            selected ? AppColors.purple.withValues(alpha: 0.05) : Colors.white,
