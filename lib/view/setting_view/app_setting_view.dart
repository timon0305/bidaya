        ...
        child: Column(
          ...
          children: [
            ClipRRect(
              ...
              child: Image.asset(AppImages.permissionPlaceholder, height: 100.h,width: 430.w, fit: BoxFit.cover,),
            ),
            verticalSpacer(24),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                customText(text: "Push Notification", fontWeight: FontWeight.w600, fontSize: 18, color: AppColors.blackShade),
